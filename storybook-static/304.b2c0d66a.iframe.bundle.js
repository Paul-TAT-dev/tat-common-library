/*! For license information please see 304.b2c0d66a.iframe.bundle.js.LICENSE.txt */
(self.webpackChunk_tat_common_library =
  self.webpackChunk_tat_common_library || []).push([
  [304],
  {
    "./node_modules/className/index.js": (module, exports) => {
      ...
      !(function () {
        ...
        function parseValue(arg) {
          ...
          if (Array.isArray(arg)) return className.apply(null, arg);
          if (
        ...
        module.exports
          ? ((className.default = className), (module.exports = className))
          : void 0 ===
    ...
    "./node_modules/domelementtype/lib/index.js": (
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        ...
        (exports.isTag = function isTag(elem) {
          return (
    ...
    "./node_modules/domhandler/lib/index.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      var domelementtype_1 = __webpack_require__(
        ...
        node_js_1 = __webpack_require__(
          "./node_modules/domhandler/lib/node.js"
        );
      __exportStar(
        __webpack_require__("./node_modules/domhandler/lib/node.js"),
        exports
      );
      var defaultOpts = {
          withStartIndices: !1,
          ...
          function DomHandler(callback, options, elementCB) {
            (this.dom = []),
              ...
              "object" == typeof callback &&
                ((options = callback), (callback = void 0)),
              (this.callback = null != callback ? callback : null),
              (this.options = null != options ? options : defaultOpts),
          ...
          return (
            ...
            (DomHandler.prototype.onclosetag = function () {
              ...
              this.options.withEndIndices &&
                ...
                this.elementCB && this.elementCB(elem);
            }),
    ...
    "./node_modules/domhandler/lib/node.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
        ...
        Node = (function () {
          ...
          return (
            ...
            (Node.prototype.cloneNode = function (recursive) {
              return (
                void 0 === recursive && (recursive = !1),
                cloneNode(this, recursive)
              );
            }),
            Node
          );
      ...
      var NodeWithChildren = (function (_super) {
        ...
        return (
          ...
          Object.defineProperty(NodeWithChildren.prototype, "firstChild", {
            get: function () {
              var _a;
              return null !== (_a = this.children[0]) && void 0 !== _a
                ? _a
                : null;
            },
            enumerable: !1,
            ...
            get: function () {
              ...
              return Object.keys(this.attribs).map(function (name) {
                ...
                return {
                  ...
                  namespace:
                    null === (_a = _this["x-attribsNamespace"]) || void 0 === _a
                      ? void 0
                      : _a[name],
                  prefix:
                    null === (_b = _this["x-attribsPrefix"]) || void 0 === _b
                      ? void 0
                      : _b[name],
                };
              });
      ...
      function cloneNode(node, recursive) {
        var result;
        if ((void 0 === recursive && (recursive = !1), isText(node)))
          ...
          children.forEach(function (child) {
            ...
            null != node.namespace && (clone_1.namespace = node.namespace),
          ...
          children.forEach(function (child) {
            ...
            node["x-mode"] && (clone_3["x-mode"] = node["x-mode"]),
            (result = clone_3);
        } else {
          if (!isDirective(node))
      ...
      (exports.Element = Element),
        ...
        (exports.hasChildren = function hasChildren(node) {
    ...
    "./node_modules/html-dom-parser/lib/client/constants.js": (
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.CARRIAGE_RETURN_PLACEHOLDER_REGEX =
          exports.CARRIAGE_RETURN_PLACEHOLDER =
          exports.CARRIAGE_RETURN_REGEX =
          exports.CARRIAGE_RETURN =
        ...
        (exports.CASE_SENSITIVE_TAG_NAMES_MAP =
          exports.CASE_SENSITIVE_TAG_NAMES.reduce(function (
            accumulator,
            tagName
          ) {
            return (accumulator[tagName.toLowerCase()] = tagName), accumulator;
          },
          {})),
        (exports.CARRIAGE_RETURN = "\r"),
        (exports.CARRIAGE_RETURN_REGEX = new RegExp(
          exports.CARRIAGE_RETURN,
          "g"
        )),
        (exports.CARRIAGE_RETURN_PLACEHOLDER =
        ...
        (exports.CARRIAGE_RETURN_PLACEHOLDER_REGEX = new RegExp(
          exports.CARRIAGE_RETURN_PLACEHOLDER,
          "g"
        ));
    },
    "./node_modules/html-dom-parser/lib/client/domparser.js": (
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = function domparser(html) {
          var _a,
            _b,
            match = (html = (0, utilities_1.escapeSpecialCharacters)(
              html
            )).match(FIRST_TAG_REGEX),
            firstTagName = match && match[1] ? match[1].toLowerCase() : "";
          switch (firstTagName) {
            case HTML:
              ...
              if (!HEAD_TAG_REGEX.test(html))
                null ===
                  (_a =
                    null == (element = doc.querySelector(HEAD))
                      ? void 0
                      : element.parentNode) ||
                  void 0 === _a ||
              ...
              if (!BODY_TAG_REGEX.test(html))
                null ===
                  (_b =
                    null == (element = doc.querySelector(BODY))
                      ? void 0
                      : element.parentNode) ||
                  void 0 === _b ||
            ...
            case BODY:
              var elements =
                parseFromDocument(html).querySelectorAll(firstTagName);
              return BODY_TAG_REGEX.test(html) && HEAD_TAG_REGEX.test(html)
                ? elements[0].parentNode.childNodes
                : elements;
            default:
              return parseFromTemplate
                ? parseFromTemplate(html)
      ...
      var utilities_1 = __webpack_require__(
        ...
        HEAD = "head",
        BODY = "body",
        FIRST_TAG_REGEX = /<([a-zA-Z]+[0-9]?)/,
        HEAD_TAG_REGEX = /<head[^]*>/i,
        ...
        DOMParser = "object" == typeof window && window.DOMParser;
      if ("function" == typeof DOMParser) {
        var domParser_1 = new DOMParser();
        parseFromDocument = parseFromString = function (html, tagName) {
          return (
            tagName &&
              (html = "<"
                .concat(tagName, ">")
                .concat(html, "</")
                .concat(tagName, ">")),
            domParser_1.parseFromString(html, "text/html")
          );
        };
      }
      if ("object" == typeof document && document.implementation) {
        ...
        parseFromDocument = function (html, tagName) {
          if (tagName) {
            ...
            return element && (element.innerHTML = html), htmlDocument_1;
          }
          return (
            (htmlDocument_1.documentElement.innerHTML = html), htmlDocument_1
          );
        };
      }
      ...
      template &&
        ...
        (parseFromTemplate = function (html) {
          return (template.innerHTML = html), template.content.childNodes;
        });
    },
    "./node_modules/html-dom-parser/lib/client/html-to-dom.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = function HTMLDOMParser(html) {
          if ("string" != typeof html)
            throw new TypeError("First argument must be a string");
          if (!html) return [];
          var match = html.match(DIRECTIVE_REGEX),
            directive = match ? match[1] : void 0;
      ...
      var domparser_1 = __importDefault(
          __webpack_require__(
            "./node_modules/html-dom-parser/lib/client/domparser.js"
          )
        ),
        utilities_1 = __webpack_require__(
          "./node_modules/html-dom-parser/lib/client/utilities.js"
        ),
        DIRECTIVE_REGEX = /<(![a-zA-Z\s]+)>/;
    },
    "./node_modules/html-dom-parser/lib/client/utilities.js": (
      __unused_webpack_module,
      exports,
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        ...
        (exports.escapeSpecialCharacters = function escapeSpecialCharacters(
          html
        ) {
          return html.replace(
            constants_1.CARRIAGE_RETURN_REGEX,
            constants_1.CARRIAGE_RETURN_PLACEHOLDER
          );
        }),
        (exports.revertEscapedCharacters = revertEscapedCharacters),
        (exports.formatDOM = function formatDOM(nodes, parent, directive) {
          void 0 === parent && (parent = null);
          for (
            var current, domNodes = [], index = 0, nodesLength = nodes.length;
            index < nodesLength;
            index++
          ) {
            ...
            switch (node.nodeType) {
              case 1:
                ...
                break;
              case 3:
                current = new domhandler_1.Text(
                  revertEscapedCharacters(node.nodeValue)
                );
                break;
              case 8:
          ...
          directive &&
            (((current = new domhandler_1.ProcessingInstruction(
              ...
              directive
            )).next = domNodes[0] || null),
            (current.parent = parent),
            domNodes.unshift(current),
            domNodes[1] && (domNodes[1].prev = domNodes[0]));
          return domNodes;
        });
      ...
      function formatAttributes(attributes) {
        for (
          var map = {}, index = 0, attributesLength = attributes.length;
          index < attributesLength;
          index++
        ) {
      ...
      function formatTagName(tagName) {
        var caseSensitiveTagName = (function getCaseSensitiveTagName(tagName) {
          return constants_1.CASE_SENSITIVE_TAG_NAMES_MAP[tagName];
        })((tagName = tagName.toLowerCase()));
        return caseSensitiveTagName || tagName;
      }
      function revertEscapedCharacters(text) {
        return text.replace(
          constants_1.CARRIAGE_RETURN_PLACEHOLDER_REGEX,
          constants_1.CARRIAGE_RETURN
        );
      }
    },
    "./node_modules/html-react-parser/esm/index.mjs": (
      ...
      var _lib_index_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
        ...
        _lib_index_js__WEBPACK_IMPORTED_MODULE_0___default =
          __webpack_require__.n(_lib_index_js__WEBPACK_IMPORTED_MODULE_0__);
      const __WEBPACK_DEFAULT_EXPORT__ =
        _lib_index_js__WEBPACK_IMPORTED_MODULE_0___default().default ||
        _lib_index_js__WEBPACK_IMPORTED_MODULE_0___default();
    },
    "./node_modules/html-react-parser/lib/attributes-to-props.js": (
      ...
      "use strict";
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = function attributesToProps(attributes, nodeName) {
          void 0 === attributes && (attributes = {});
          var props = {},
          ...
          for (var attributeName in attributes) {
            ...
            if ((0, react_property_1.isCustomAttribute)(attributeName))
              ...
              if (propName) {
                var propertyInfo = (0, react_property_1.getPropertyInfo)(
                  propName
                );
                switch (
                  (UNCONTROLLED_COMPONENT_ATTRIBUTES.includes(propName) &&
                    ...
                    (propName = getPropName(
                      "default" + attributeNameLowerCased
                    )),
                  ...
                  case react_property_1.OVERLOADED_BOOLEAN:
                    "" === attributeValue && (props[propName] = !0);
                }
              } else
          ...
          return (0, utilities_1.setStyleProp)(attributes.style, props), props;
        });
      var react_property_1 = __webpack_require__(
          "./node_modules/react-property/lib/index.js"
        ),
        utilities_1 = __webpack_require__(
          "./node_modules/html-react-parser/lib/utilities.js"
        ),
        UNCONTROLLED_COMPONENT_ATTRIBUTES = ["checked", "value"],
        UNCONTROLLED_COMPONENT_NAMES = ["input", "select", "textarea"],
        valueOnlyInputs = { reset: !0, submit: !0 };
      function getPropName(attributeName) {
        return react_property_1.possibleStandardNames[attributeName];
      }
    },
    "./node_modules/html-react-parser/lib/dom-to-react.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = function domToReact(nodes, options) {
          void 0 === options && (options = {});
          for (
            var reactElements = [],
              hasReplace = "function" == typeof options.replace,
              transform = options.transform || utilities_1.returnFirstArg,
              _a = options.library || React,
            ...
            if ("text" !== node.type) {
              var element = node,
                props = {};
              skipAttributesToProps(element)
                ? ((0, utilities_1.setStyleProp)(
                    element.attribs.style,
                    element.attribs
                  ),
                  (props = element.attribs))
                : element.attribs &&
                  (props = (0, attributes_to_props_1.default)(
                    element.attribs,
                    element.name
                  ));
              var children = void 0;
              switch (node.type) {
                ...
                case "style":
                  ...
                  break;
                case "tag":
                  "textarea" === node.name && node.children[0]
          ...
          return 1 === reactElements.length ? reactElements[0] : reactElements;
        });
      var react_1 = __webpack_require__("./node_modules/react/index.js"),
        attributes_to_props_1 = __importDefault(
          __webpack_require__(
            "./node_modules/html-react-parser/lib/attributes-to-props.js"
          )
        ),
    ...
    "./node_modules/html-react-parser/lib/index.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.htmlToDOM =
          ...
          exports.Comment =
            void 0),
        (exports.default = function HTMLReactParser(html, options) {
          if ("string" != typeof html)
            throw new TypeError("First argument must be a string");
          if (!html) return [];
          return (0, dom_to_react_1.default)(
            (0, html_dom_parser_1.default)(
              html,
              (null == options ? void 0 : options.htmlparser2) ||
                domParserOptions
            ),
            options
          );
        });
      var html_dom_parser_1 = __importDefault(
        __webpack_require__(
          "./node_modules/html-dom-parser/lib/client/html-to-dom.js"
        )
      );
      exports.htmlToDOM = html_dom_parser_1.default;
      var attributes_to_props_1 = __importDefault(
        __webpack_require__(
          "./node_modules/html-react-parser/lib/attributes-to-props.js"
        )
      );
      exports.attributesToProps = attributes_to_props_1.default;
      var dom_to_react_1 = __importDefault(
        __webpack_require__(
      ...
      var domParserOptions = { lowerCaseAttributeNames: !1 };
    },
    "./node_modules/html-react-parser/lib/utilities.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.returnFirstArg =
          ...
          exports.PRESERVE_CUSTOM_ATTRIBUTES =
            void 0),
        (exports.isCustomComponent = function isCustomComponent(
          tagName,
          props
        ) {
          if (!tagName.includes("-"))
            return Boolean(props && "string" == typeof props.is);
          if (RESERVED_SVG_MATHML_ELEMENTS.has(tagName)) return !1;
          return !0;
        }),
        (exports.setStyleProp = function setStyleProp(style, props) {
          if ("string" != typeof style) return;
          if (!style.trim()) return void (props.style = {});
          try {
      ...
      var react_1 = __webpack_require__("./node_modules/react/index.js"),
        style_to_js_1 = __importDefault(
          __webpack_require__("./node_modules/style-to-js/cjs/index.js")
        ),
        RESERVED_SVG_MATHML_ELEMENTS = new Set([
          "annotation-xml",
          "color-profile",
          "font-face",
          "font-face-src",
      ...
      var styleOptions = { reactCompat: !0 };
      (exports.PRESERVE_CUSTOM_ATTRIBUTES =
      ...
      exports.canTextBeChildOfNode = function (node) {
        return !exports.ELEMENTS_WITH_NO_TEXT_CHILDREN.has(node.name);
      };
      exports.returnFirstArg = function (arg) {
        return arg;
      };
    },
    "./node_modules/inline-style-parser/index.js": (module) => {
      var COMMENT_REGEX = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//g,
        NEWLINE_REGEX = /\n/g,
        WHITESPACE_REGEX = /^\s*/,
        ...
        function declaration() {
          ...
          if (prop) {
            ...
            var val = match(VALUE_REGEX),
              ret = pos({
                type: "declaration",
                property: trim(prop[0].replace(COMMENT_REGEX, "")),
    ...
    "./node_modules/invariant/browser.js": (module) => {
      "use strict";
    ...
    "./node_modules/lucide-react/dist/esm/icons/circle-question-mark.js": (
      ...
      "use strict";
      __webpack_require__.d(__webpack_exports__, {
        A: () => CircleQuestionMark,
      });
      const CircleQuestionMark = (0,
      __webpack_require__(
        "./node_modules/lucide-react/dist/esm/createLucideIcon.js"
      ).A)("circle-question-mark", [
    ...
    "./node_modules/react-bootstrap/esm/OverlayTrigger.js": (
      ...
      function contains(context, node) {
        return context.contains
          ...
          ? context === node || !!(16 & context.compareDocumentPosition(node))
          : void 0;
      }
      __webpack_require__.d(__webpack_exports__, {
        A: () => esm_OverlayTrigger,
      });
      ...
      function useWillUnmount(fn) {
        const onUnmount = (function useUpdatedRef(value) {
          const valueRef = (0, react.useRef)(value);
          return (valueRef.current = value), valueRef;
        })(fn);
      ...
      function useTimeout() {
        const isMounted = (function useMounted() {
            const mounted = (0, react.useRef)(!0),
              isMounted = (0, react.useRef)(() => mounted.current);
            return (
              (0, react.useEffect)(
                () => (
                  (mounted.current = !0),
          ...
          handleRef = (0, react.useRef)();
        return (
          useWillUnmount(() => clearTimeout(handleRef.current)),
          (0, react.useMemo)(() => {
            const clear = () => clearTimeout(handleRef.current);
            return {
              set: function set(fn, delayMs = 0) {
                isMounted() &&
                  (clear(),
                  delayMs <= 2147483647
      ...
      const toFnRef = (ref) =>
        ref && "function" != typeof ref
          ? (value) => {
              ref.current = value;
            }
          : ref;
      const esm_useMergedRefs = function useMergedRefs(refA, refB) {
      ...
      function getChildRef(element) {
        if (!element || "function" == typeof element) return null;
        const { major } = (function getReactVersion() {
          const parts = react.version.split(".");
          return { major: +parts[0], minor: +parts[1], patch: +parts[2] };
        })();
        return major >= 19 ? element.props.ref : element.ref;
      }
      var className = __webpack_require__("./node_modules/className/index.js"),
        className_default = __webpack_require__.n(className),
        react_dom = __webpack_require__("./node_modules/react-dom/index.js");
      function useCallbackRef() {
        return (0, react.useState)(null);
      }
      const useMergedRefs_toFnRef = (ref) =>
        ref && "function" != typeof ref
          ? (value) => {
              ref.current = value;
            }
          : ref;
      const hooks_esm_useMergedRefs = function useMergedRefs_useMergedRefs(
        refA,
        refB
      ) {
        return (0, react.useMemo)(
      ...
      const esm_useSafeState = function useSafeState(state) {
        const isMounted = (function useMounted_useMounted() {
          const mounted = (0, react.useRef)(!0),
            isMounted = (0, react.useRef)(() => mounted.current);
          return (
            (0, react.useEffect)(
        ...
        return [
          ...
          (0, react.useCallback)(
            (nextState) => {
              if (isMounted()) return state[1](nextState);
            },
            [isMounted, state[1]]
          ),
        ];
      ...
      const modifiers_arrow = {
        ...
        effect: function effect(_ref2) {
          ...
          null != arrowElement &&
            ...
            contains_contains(state.elements.popper, arrowElement) &&
              ...
              ? (function getClippingParents(element) {
                  ...
                  return isElement(clipperElement)
                    ? clippingParents.filter(function (clippingParent) {
                        return (
                          isElement(clippingParent) &&
                          contains_contains(clippingParent, clipperElement) &&
                              ...
                              placements = variation
                                ? flipVariations
                                  ...
                                  : variationPlacements.filter(function (
                                      ...
                                      return (
                                        getVariation(placement) === variation
                                      );
                                    })
                                : basePlacements,
                              allowedPlacements = placements.filter(function (
                                placement
                              ) {
                                return (
          ...
          if (popperOffsets) {
            ...
            if (checkAltAxis) {
              var _offsetModifierState$2,
                ...
                isOriginSide = -1 !== [enums_top, left].indexOf(basePlacement),
      ...
      const disabledApplyStylesModifier = {
        ...
        EMPTY_MODIFIERS = [];
      const esm_usePopper = function usePopper(
          referenceElement,
          popperElement,
          _ref = {}
        ) {
          let {
            ...
            config = (function usePopper_objectWithoutPropertiesLoose(r, e) {
              if (null == r) return {};
              var t = {};
              for (var n in r)
      ...
      var optionsSupported = !1,
        onceSupported = !1;
      try {
        var options = {
          get passive() {
            return (optionsSupported = !0);
          },
          get once() {
            return (onceSupported = optionsSupported = !0);
          },
        };
        canUseDOM &&
          (window.addEventListener("test", options, options),
          window.removeEventListener("test", options, !0));
      } catch (e) {}
      const esm_addEventListener = function addEventListener(
        node,
        eventName,
        handler,
        options
      ) {
        if (options && "boolean" != typeof options && !onceSupported) {
      ...
      const esm_removeEventListener = function removeEventListener(
        node,
        eventName,
        handler,
        options
        ...
        var capture =
          options && "boolean" != typeof options ? options.capture : options;
        node.removeEventListener(eventName, handler, capture),
          handler.__once &&
            node.removeEventListener(eventName, handler.__once, capture);
      };
      const esm_listen = function listen(node, eventName, handler, options) {
        return (
      ...
      const esm_useCommittedRef = function useCommittedRef(value) {
      ...
      const esm_useClickOutside = function useClickOutside(
          ref,
          onClickOutside = useClickOutside_noop,
          { disabled, clickTrigger = "click" } = {}
        ) {
          const preventMouseClickOutsideRef = (0, react.useRef)(!1),
            ...
            handleInitialMouse = useEventCallback((e) => {
              const currentTarget = getRefTarget(ref);
              currentTarget && contains(currentTarget, e.target)
                ? (waitingForTrigger.current = !0)
                : (waitingForTrigger.current = !1);
            }),
            handleMouse = useEventCallback((e) => {
          ...
          (0, react.useEffect)(() => {
            ...
            const doc = ownerDocument(getRefTarget(ref)),
              ownerWindow = doc.defaultView || window;
            let currentEvent =
                null != (_ownerWindow$event = ownerWindow.event)
                  ? _ownerWindow$event
                  : null == (_ownerWindow$parent = ownerWindow.parent)
                  ? void 0
                  : _ownerWindow$parent.event,
              removeInitialTriggerListener = null;
            InitialTriggerEvents[clickTrigger] &&
              (removeInitialTriggerListener = esm_listen(
                doc,
                InitialTriggerEvents[clickTrigger],
                handleInitialMouse,
                !0
              ));
            const removeMouseCaptureListener = esm_listen(
                doc,
                clickTrigger,
                handleMouseCapture,
                !0
              ),
              removeMouseListener = esm_listen(doc, clickTrigger, (e) => {
                e !== currentEvent ? handleMouse(e) : (currentEvent = void 0);
              });
            ...
            return (
              "ontouchstart" in doc.documentElement &&
                (mobileSafariHackListeners = [].slice
                  ...
                  .map((el) =>
                    esm_listen(el, "mousemove", useClickOutside_noop)
                  )),
              () => {
        ...
        useRootClose_noop = () => {};
      const esm_useRootClose = function useRootClose(
          ref,
          onRootClose,
          { disabled, clickTrigger } = {}
        ) {
          const onClose = onRootClose || useRootClose_noop;
          esm_useClickOutside(ref, onClose, { disabled, clickTrigger });
          ...
          (0, react.useEffect)(() => {
            ...
            const removeKeyupListener = esm_listen(doc, "keyup", (e) => {
              e !== currentEvent ? handleKeyUp(e) : (currentEvent = void 0);
            });
            return () => {
              removeKeyupListener();
            };
        ...
        Context = (0, react.createContext)(canUseDOM ? window : void 0);
      Context.Provider;
      const resolveContainerRef = (ref, document) =>
        canUseDOM
          ? null == ref
            ? (document || ownerDocument()).body
            : ("function" == typeof ref && (ref = ref()),
              ref && "current" in ref && (ref = ref.current),
              ref && ("nodeType" in ref || ref.getBoundingClientRect)
                ? ref
                : null)
          : null;
      function useWaitForDOMRef(ref, onResolved) {
        const window = (function useWindow() {
            return (0, react.useContext)(Context);
          })(),
          [resolvedRef, setRef] = (0, react.useState)(() =>
            resolveContainerRef(ref, null == window ? void 0 : window.document)
          );
        if (!resolvedRef) {
          const earlyRef = resolveContainerRef(ref);
          earlyRef && setRef(earlyRef);
        }
        return (
          (0, react.useEffect)(() => {
            onResolved && resolvedRef && onResolved(resolvedRef);
          }, [onResolved, resolvedRef]),
          (0, react.useEffect)(() => {
            const nextRef = resolveContainerRef(ref);
            nextRef !== resolvedRef && setRef(nextRef);
          }, [ref, resolvedRef]),
          resolvedRef
        );
      }
      ...
      function mergeOptionsWithPopperConfig({
        ...
        var _modifiers$eventListe,
          ...
          _modifiers$offset,
          _modifiers$arrow;
        const modifiers = (function toModifierMap(modifiers) {
          const result = {};
          ...
          modifiers: toModifierArray(
            Object.assign({}, modifiers, {
              eventListeners: {
                ...
                options:
                  null == (_modifiers$eventListe = modifiers.eventListeners)
                    ? void 0
              ...
              preventOverflow: Object.assign({}, modifiers.preventOverflow, {
                options: containerPadding
                  ? Object.assign(
                      ...
                      null ==
                        (_modifiers$preventOve = modifiers.preventOverflow)
                        ? void 0
                        : _modifiers$preventOve.options
                    )
                  : null == (_modifiers$preventOve2 = modifiers.preventOverflow)
                  ? void 0
      ...
      const isReactNative =
          ...
          "ReactNative" === __webpack_require__.g.navigator.product,
        useIsomorphicEffect =
          "undefined" != typeof document || isReactNative
            ? react.useLayoutEffect
            : react.useEffect;
      const esm_NoopTransition = function NoopTransition({
          children,
          in: inProp,
          onExited,
          mountOnEnter,
          ...
          const ref = (0, react.useRef)(null),
            hasEnteredRef = (0, react.useRef)(inProp),
            handleExited = useEventCallback(onExited);
          (0, react.useEffect)(() => {
            inProp ? (hasEnteredRef.current = !0) : handleExited(ref.current);
          }, [inProp, handleExited]);
          const combinedRef = hooks_esm_useMergedRefs(
              ref,
              getChildRef(children)
            ),
            child = (0, react.cloneElement)(children, { ref: combinedRef });
          return inProp
            ? child
            : unmountOnExit || (!hasEnteredRef.current && mountOnEnter)
            ? null
            : child;
        },
        useRTGTransitionProps_excluded = [
          "onEnter",
          "onEntering",
          "onEntered",
          "onExit",
      ...
      const esm_RTGTransition = react.forwardRef((_ref, ref) => {
        let { component: Component } = _ref;
        const transitionProps = (function useRTGTransitionProps(_ref) {
          let {
              onEnter,
              onEntering,
              onEntered,
            ...
            props =
              (function useRTGTransitionProps_objectWithoutPropertiesLoose(
                r,
                e
              ) {
                if (null == r) return {};
                ...
                return t;
              })(_ref, useRTGTransitionProps_excluded);
          const nodeRef = (0, react.useRef)(null),
            mergedRef = hooks_esm_useMergedRefs(nodeRef, getChildRef(children)),
              ...
              children:
                "function" == typeof children
                  ? (status, innerProps) =>
                      children(
                        status,
                        Object.assign({}, innerProps, { ref: mergedRef })
                      )
                  : (0, react.cloneElement)(children, { ref: mergedRef }),
            }
          );
        })(
          (function RTGTransition_objectWithoutPropertiesLoose(r, e) {
            ...
            return t;
          })(_ref, RTGTransition_excluded)
        );
        return (0, jsx_runtime.jsx)(
          Component,
          Object.assign({ ref }, transitionProps)
        );
      });
      function ImperativeTransition({
        ...
        inProp && exited && setExited(!1);
        const ref = (function useTransition({ in: inProp, onTransition }) {
            const ref = (0, react.useRef)(null),
              isInitialRef = (0, react.useRef)(!0),
              handleTransition = useEventCallback(onTransition);
            return (
              useIsomorphicEffect(() => {
              ...
              useIsomorphicEffect(
                () => (
                  (isInitialRef.current = !1),
                  () => {
                    isInitialRef.current = !0;
                  }
                ),
                []
              ),
            ...
            onTransition: (options) => {
              Promise.resolve(transition(options)).then(
                () => {
                  options.isStale() ||
                    (options.in
                      ? null == onEntered ||
                      ...
                      : (setExited(!0),
                        null == onExited || onExited(options.element)));
                },
                (error) => {
                  throw (options.in || setExited(!0), error);
                }
              );
            },
          }),
          combinedRef = hooks_esm_useMergedRefs(ref, getChildRef(children));
        return exited && !inProp
          ? null
          : (0, react.cloneElement)(children, { ref: combinedRef });
      }
      const Overlay = react.forwardRef((props, outerRef) => {
        const {
          ...
          [rootElement, attachRef] = useCallbackRef(),
          [arrowElement, attachArrowRef] = useCallbackRef(),
          mergedRef = hooks_esm_useMergedRefs(attachRef, outerRef),
          container = useWaitForDOMRef(props.container),
          target = useWaitForDOMRef(props.target),
          [exited, setExited] = (0, react.useState)(!props.show),
        ...
        let child = props.children(
          Object.assign({}, popper.attributes.popper, {
        ...
        return (
          (child = (function renderTransition(component, runTransition, props) {
            return component
              ? (0, jsx_runtime.jsx)(
                  esm_RTGTransition,
              ...
              ? (0, jsx_runtime.jsx)(
                  ...
                  Object.assign({}, props, { transition: runTransition })
                )
              : (0, jsx_runtime.jsx)(
                  esm_NoopTransition,
                  Object.assign({}, props)
          ...
          container ? react_dom.createPortal(child, container) : null
        );
      });
      Overlay.displayName = "Overlay";
      const esm_Overlay = Overlay;
      const hooks_esm_useCommittedRef =
      ...
      const useIsomorphicEffect_isReactNative =
          void 0 !== __webpack_require__.g &&
          __webpack_require__.g.navigator &&
          "ReactNative" === __webpack_require__.g.navigator.product,
        esm_useIsomorphicEffect =
          "undefined" != typeof document || useIsomorphicEffect_isReactNative
            ? react.useLayoutEffect
            : react.useEffect;
      ...
      const PopoverHeader = react.forwardRef(
        ({ className, bsPrefix, as: Component = "div", ...props }, ref) => (
          (bsPrefix = (0, ThemeProvider.oU)(bsPrefix, "popover-header")),
          (0, jsx_runtime.jsx)(Component, {
            ref,
            className: className_default()(className, bsPrefix),
            ...props,
          })
        )
      );
      PopoverHeader.displayName = "PopoverHeader";
      const esm_PopoverHeader = PopoverHeader,
        PopoverBody = react.forwardRef(
          ({ className, bsPrefix, as: Component = "div", ...props }, ref) => (
            (bsPrefix = (0, ThemeProvider.oU)(bsPrefix, "popover-body")),
            (0, jsx_runtime.jsx)(Component, {
              ref,
              className: className_default()(className, bsPrefix),
              ...props,
      ...
      const esm_PopoverBody = PopoverBody;
      var helpers = __webpack_require__(
          "./node_modules/react-bootstrap/esm/helpers.js"
        ),
        getInitialPopperStyles = __webpack_require__(
      ...
      const Popover = react.forwardRef(
        (
          ...
          const decoratedBsPrefix = (0, ThemeProvider.oU)(bsPrefix, "popover"),
            isRTL = (0, ThemeProvider.Wz)(),
            [primaryPlacement] =
              (null == placement ? void 0 : placement.split("-")) || [],
            bsDirection = (0, helpers.G)(primaryPlacement, isRTL);
          ...
          return (
            show &&
              ...
              (computedStyle = {
                ...style,
                ...(0, getInitialPopperStyles.A)(
                  null == popper ? void 0 : popper.strategy
                ),
              }),
            (0, jsx_runtime.jsxs)("div", {
              ...
              children: [
                ...
                body
                  ? (0, jsx_runtime.jsx)(esm_PopoverBody, { children })
                  : children,
              ],
            })
          );
      ...
      const esm_Popover = Object.assign(Popover, {
      ...
      function getComputedStyle_getComputedStyle(node, psuedoElement) {
        return (function ownerWindow(node) {
          var doc = ownerDocument(node);
          return (doc && doc.defaultView) || window;
        })(node).getComputedStyle(node, psuedoElement);
      }
      var rUpper = /([A-Z])/g;
      var msPattern = /^ms-/;
      function hyphenateStyleName(string) {
        return (function hyphenate(string) {
          return string.replace(rUpper, "-$1").toLowerCase();
        })(string).replace(msPattern, "-ms-");
      }
      var supportedTransforms =
        /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i;
      const css = function style(node, property) {
        var css = "",
          transforms = "";
        if ("string" == typeof property)
          return (
            node.style.getPropertyValue(hyphenateStyleName(property)) ||
            getComputedStyle_getComputedStyle(node).getPropertyValue(
        ...
        Object.keys(property).forEach(function (key) {
          ...
          transforms && (css += "transform: " + transforms + ";"),
          (node.style.cssText += ";" + css);
      };
      function emulateTransitionEnd(element, duration, padding) {
        void 0 === padding && (padding = 5);
        var called = !1,
      ...
      function transitionEnd(element, handler, duration, padding) {
        ...
        var removeEmulate = emulateTransitionEnd(element, duration, padding),
          remove = esm_listen(element, "transitionend", handler);
        return function () {
          removeEmulate(), remove();
        };
      }
      ...
      function transitionEndListener(element, handler) {
        const duration = transitionEndListener_parseDuration(
            element,
            "transitionDuration"
          ),
          delay = transitionEndListener_parseDuration(
            element,
            "transitionDelay"
          ),
      ...
      function safeFindDOMNode(componentOrElement) {
        return componentOrElement && "setState" in componentOrElement
          ? react_dom.findDOMNode(componentOrElement)
      ...
      const TransitionWrapper = react.forwardRef(
        (
          ...
          const nodeRef = (0, react.useRef)(null),
            mergedRef = esm_useMergedRefs(nodeRef, childRef),
            attachRef = (r) => {
          ...
          return (0, jsx_runtime.jsx)(esm_Transition, {
            ref,
            ...props,
            onEnter: handleEnter,
      ...
      const esm_TransitionWrapper = TransitionWrapper,
        fadeStyles = { [ENTERING]: "show", [ENTERED]: "show" },
        Fade = react.forwardRef(
          (
            ...
            const props = {
              ...
              handleEnter = (0, react.useCallback)(
                (node, isAppearing) => {
                  !(function triggerBrowserReflow(node) {
                    node.offsetHeight;
                  })(node),
                    null == onEnter || onEnter(node, isAppearing);
                },
                [onEnter]
              );
            return (0, jsx_runtime.jsx)(esm_TransitionWrapper, {
              ref,
      ...
      const esm_Fade = Fade;
      const Overlay_Overlay = react.forwardRef(
        (
          {
            children: overlay,
            transition = esm_Fade,
          ...
          const popperRef = (0, react.useRef)({}),
            [firstRenderedState, setFirstRenderedState] = (0, react.useState)(
              null
            ),
            [ref, modifiers] = (function useOverlayOffset(customOffset) {
              const overlayRef = (0, react.useRef)(null),
                popoverClass = (0, ThemeProvider.oU)(void 0, "popover"),
                tooltipClass = (0, ThemeProvider.oU)(void 0, "tooltip"),
                offset = (0, react.useMemo)(
                  () => ({
                    name: "offset",
                    options: {
                      offset: () => {
                        ...
                        if (overlayRef.current) {
                          ...
                          if (hasClass(overlayRef.current, tooltipClass))
                            return Tooltip.A.TOOLTIP_OFFSET;
                        }
                        return [0, 0];
                      },
                    },
            ...
            mergedRef = esm_useMergedRefs(outerRef, ref),
            actualTransition =
              !0 === transition ? esm_Fade : transition || void 0,
            handleFirstUpdate = (function useEventCallback_useEventCallback(
              fn
            ) {
              ...
              setFirstRenderedState(state),
                null == popperConfig ||
                  null == popperConfig.onFirstUpdate ||
          ...
          return (
            esm_useIsomorphicEffect(() => {
              firstRenderedState &&
                outerProps.target &&
                (null == popperRef.current.scheduleUpdate ||
                  popperRef.current.scheduleUpdate());
            }, [firstRenderedState, outerProps.target]),
            (0, react.useEffect)(() => {
              outerShow || setFirstRenderedState(null);
            }, [outerShow]),
            (0, jsx_runtime.jsx)(esm_Overlay, {
              ...outerProps,
              ref: mergedRef,
              popperConfig: {
                ...popperConfig,
              ...
              children: (
                ...
                !(function wrapRefs(props, arrowProps) {
                  ...
                  (props.ref =
                    ref.__wrapped ||
                    (ref.__wrapped = (r) => ref(safeFindDOMNode(r)))),
                    (arrowProps.ref =
                      aRef.__wrapped ||
                      (aRef.__wrapped = (r) => aRef(safeFindDOMNode(r))));
                })(overlayProps, arrowProps);
                const updatedPlacement =
                    null == popperObj ? void 0 : popperObj.placement,
                  popper = Object.assign(popperRef.current, {
                    state: null == popperObj ? void 0 : popperObj.state,
                    scheduleUpdate:
                      null == popperObj ? void 0 : popperObj.update,
                    placement: updatedPlacement,
                    outOfBoundaries:
                      (null == popperObj ||
                      null == (_popperObj$state = popperObj.state) ||
                      null ==
                        (_popperObj$state = _popperObj$state.modifiersData.hide)
                        ? void 0
                        : _popperObj$state.isReferenceHidden) || !1,
                    strategy: popperConfig.strategy,
                  }),
                  hasDoneInitialMeasure = !!firstRenderedState;
                return "function" == typeof overlay
                  ? overlay({
                      ...overlayProps,
                      placement: updatedPlacement,
                      show,
      ...
      const react_bootstrap_esm_Overlay = Overlay_Overlay;
      function handleMouseOverOut(handler, args, relatedNative) {
        const [e] = args,
          target = e.currentTarget,
          related = e.relatedTarget || e.nativeEvent[relatedNative];
        (related && related === target) ||
          contains(target, related) ||
          handler(...args);
      }
      prop_types_default().oneOf(["click", "hover", "focus"]);
      const esm_OverlayTrigger = ({
        trigger = ["hover", "focus"],
        overlay,
        children,
        popperConfig = {},
        ...
        delay: propsDelay,
        placement,
        flip = placement && -1 !== placement.indexOf("auto"),
        ...props
      }) => {
        const triggerNodeRef = (0, react.useRef)(null),
          mergedRef = esm_useMergedRefs(triggerNodeRef, getChildRef(children)),
          timeout = useTimeout(),
          hoverStateRef = (0, react.useRef)(""),
          [show, setShow] = useUncontrolledProp(
            propsShow,
            defaultShow,
            onToggle
          ),
          delay = (function normalizeDelay(delay) {
            return delay && "object" == typeof delay
              ? delay
          ...
          handleShow = (0, react.useCallback)(() => {
            timeout.clear(),
              ...
              delay.show
                ? timeout.set(() => {
                    "show" === hoverStateRef.current && setShow(!0);
                  }, delay.show)
                : setShow(!0);
          }, [delay.show, setShow, timeout]),
          handleHide = (0, react.useCallback)(() => {
            timeout.clear(),
              (hoverStateRef.current = "hide"),
              delay.hide
                ? timeout.set(() => {
                    "hide" === hoverStateRef.current && setShow(!1);
                  }, delay.hide)
                : setShow(!1);
          }, [delay.hide, setShow, timeout]),
          handleFocus = (0, react.useCallback)(
            (...args) => {
              handleShow(), null == onFocus || onFocus(...args);
            },
            [handleShow, onFocus]
          ),
          handleBlur = (0, react.useCallback)(
            (...args) => {
              handleHide(), null == onBlur || onBlur(...args);
            },
            [handleHide, onBlur]
          ),
          handleClick = (0, react.useCallback)(
            (...args) => {
              setShow(!show), null == onClick || onClick(...args);
            },
          ...
          triggers = null == trigger ? [] : [].concat(trigger),
          triggerProps = {
            ref: (r) => {
              mergedRef(safeFindDOMNode(r));
            },
        ...
        return (
          -1 !== triggers.indexOf("click") &&
            (triggerProps.onClick = handleClick),
          -1 !== triggers.indexOf("focus") &&
            ((triggerProps.onFocus = handleFocus),
            (triggerProps.onBlur = handleBlur)),
          -1 !== triggers.indexOf("hover") &&
          ...
          (0, jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
              "function" == typeof children
                ...
                : (0, react.cloneElement)(children, triggerProps),
              (0, jsx_runtime.jsx)(react_bootstrap_esm_Overlay, {
                ...props,
                show,
                onHide: handleHide,
                flip,
    ...
    "./node_modules/react-bootstrap/esm/ThemeProvider.js": (
      ...
      function useBootstrapPrefix(prefix, defaultPrefix) {
        const { prefixes } = (0, react__WEBPACK_IMPORTED_MODULE_0__.useContext)(
          ThemeContext
        );
        return prefix || prefixes[defaultPrefix] || defaultPrefix;
      }
      function useIsRTL() {
        const { dir } = (0, react__WEBPACK_IMPORTED_MODULE_0__.useContext)(
          ThemeContext
        );
        return "rtl" === dir;
      }
    ...
    "./node_modules/react-bootstrap/esm/Tooltip.js": (
      ...
      var className__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
          "./node_modules/className/index.js"
        ),
        className__WEBPACK_IMPORTED_MODULE_0___default = __webpack_require__.n(
          className__WEBPACK_IMPORTED_MODULE_0__
        ),
        react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
          "./node_modules/react/index.js"
        ),
        _ThemeProvider__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
          "./node_modules/react-bootstrap/esm/ThemeProvider.js"
        ),
        _helpers__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
          "./node_modules/react-bootstrap/esm/helpers.js"
        ),
        _getInitialPopperStyles__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(
            "./node_modules/react-bootstrap/esm/getInitialPopperStyles.js"
          ),
      ...
      const Tooltip = react__WEBPACK_IMPORTED_MODULE_1__.forwardRef(
        (
          {
            bsPrefix,
            placement = "right",
          ...
          bsPrefix = (0, _ThemeProvider__WEBPACK_IMPORTED_MODULE_2__.oU)(
            bsPrefix,
            "tooltip"
          );
          const isRTL = (0, _ThemeProvider__WEBPACK_IMPORTED_MODULE_2__.Wz)(),
            [primaryPlacement] =
              (null == placement ? void 0 : placement.split("-")) || [],
            bsDirection = (0, _helpers__WEBPACK_IMPORTED_MODULE_3__.G)(
              primaryPlacement,
              isRTL
            );
          let computedStyle = style;
          return (
            show &&
              ...
              (computedStyle = {
                ...style,
                ...(0, _getInitialPopperStyles__WEBPACK_IMPORTED_MODULE_4__.A)(
                  null == popper ? void 0 : popper.strategy
                ),
              }),
            (0, react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
              ...
              role: "tooltip",
              "x-placement": primaryPlacement,
              className: className__WEBPACK_IMPORTED_MODULE_0___default()(
                className,
                bsPrefix,
      ...
      const __WEBPACK_DEFAULT_EXPORT__ = Object.assign(Tooltip, {
        TOOLTIP_OFFSET: [0, 6],
      });
    },
    "./node_modules/react-bootstrap/esm/getInitialPopperStyles.js": (
      ...
      function getOverlayDirection(placement, isRTL) {
        ...
        return (
          "left" === placement
            ...
            : "right" === placement && (bsDirection = isRTL ? "start" : "end"),
          bsDirection
        );
      }
    },
    "./node_modules/react-property/lib/index.js": (
      ...
      const {
        ...
        possibleStandardNames = Object.keys(
      ...
      (exports.BOOLEAN = 3),
        (exports.BOOLEANISH_STRING = 2),
        (exports.NUMERIC = 5),
        (exports.OVERLOADED_BOOLEAN = 4),
        (exports.POSITIVE_NUMERIC = 6),
        (exports.RESERVED = 0),
        (exports.STRING = 1),
        (exports.getPropertyInfo = function getPropertyInfo(name) {
    ...
    "./node_modules/style-to-js/cjs/index.js": function (
      module,
      ...
      var style_to_object_1 = (
        ...
        )(__webpack_require__("./node_modules/style-to-object/cjs/index.js")),
        utilities_1 = __webpack_require__(
          "./node_modules/style-to-js/cjs/utilities.js"
        );
      function StyleToJS(style, options) {
        var output = {};
        return style && "string" == typeof style
          ...
          (function (property) {
            ...
            : ((property = property.toLowerCase()),
              (property = options.reactCompat
                ...
                : property.replace(VENDOR_PREFIX_REGEX, trimHyphen)).replace(
                HYPHEN_REGEX,
                capitalize
              ))
        );
    ...
    "./node_modules/style-to-object/cjs/index.js": function (
      __unused_webpack_module,
      exports,
      __webpack_require__
    ) {
      ...
      Object.defineProperty(exports, "__esModule", { value: !0 }),
        (exports.default = function StyleToObject(style, iterator) {
          var styleObject = null;
          if (!style || "string" != typeof style) return styleObject;
          var declarations = (0, inline_style_parser_1.default)(style),
            hasIterator = "function" == typeof iterator;
          return (
            declarations.forEach(function (declaration) {
              if ("declaration" === declaration.type) {
                ...
                hasIterator
                  ...
                  : value &&
                    ((styleObject = styleObject || {})[property] = value);
              }
            }),
            styleObject
          );
      ...
      var inline_style_parser_1 = __importDefault(
        __webpack_require__("./node_modules/inline-style-parser/index.js")
      );
    },
  },
]);
